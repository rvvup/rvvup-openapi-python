...
class TestPaymentMethodDetailsPage(unittest.TestCase):
    """PaymentMethodDetailsPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentMethodDetailsPage:
        """Test PaymentMethodDetailsPage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentMethodDetailsPage`
        """
        model = PaymentMethodDetailsPage()
        if include_optional:
    ...
    def testPaymentMethodDetailsPage(self):
        """Test PaymentMethodDetailsPage"""

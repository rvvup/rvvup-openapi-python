...
class MoneyInput(BaseModel):
    ...
    MoneyInput
    """ # noqa: E501
    amount: StrictStr = Field(description="The amount as a string.")
    currency: Annotated[str, Field(strict=True)] = Field(description="The three-letter ISO-4217 currency code of the amount.")
    __properties: ClassVar[List[str]] = ["amount", "currency"]

    @field_validator('currency')
    def currency_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"GBP", value):
            raise ValueError(r"must validate the regular expression /GBP/")
        return value

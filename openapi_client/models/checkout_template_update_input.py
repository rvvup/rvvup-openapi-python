...
class CheckoutTemplateUpdateInput(BaseModel):
    """
    The input for updating a checkout template.
    """ # noqa: E501
    amount_type: Optional[CheckoutAmountType] = Field(default=None, alias="amountType")
    customer_fields: Optional[CheckoutCustomerFieldsUpdateInput] = Field(default=None, alias="customerFields")
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, description="The name of the checkout template.")
    ...
    payment_method_settings: Optional[CheckoutPaymentMethodSettingsUpdateInput] = Field(default=None, alias="paymentMethodSettings")
    __properties: ClassVar[List[str]] = ["amountType", "customerFields", "enabledPaymentMethods", "name", "notifyCustomer", "notifyMerchant", "paymentMethodSettings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customerFields": CheckoutCustomerFieldsUpdateInput.from_dict(obj["customerFields"]) if obj.get("customerFields") is not None else None,
            ...
            "paymentMethodSettings": CheckoutPaymentMethodSettingsUpdateInput.from_dict(obj["paymentMethodSettings"]) if obj.get("paymentMethodSettings") is not None else None
        })
        return _obj

...
class WebhookCreateInput(BaseModel):
    ...
    """ # noqa: E501
    headers: Optional[Dict[str, Optional[StrictStr]]] = Field(description="Custom headers for the webhook")
    subscribed_events: Annotated[List[WebhookEventType], Field(min_length=1, max_length=2147483647)] = Field(description="The events to subscribe to.", alias="subscribedEvents")
    url: StrictStr = Field(description="The URL to send the webhook event to.")
    __properties: ClassVar[List[str]] = ["headers", "subscribedEvents", "url"]

...
class CheckoutPaymentMethodSettings(BaseModel):
    """
    The payment method settings to be used for the checkout.
    """ # noqa: E501
    apple_pay: Optional[CheckoutApplePaySettings] = Field(default=None, alias="applePay")
    card: Optional[CheckoutCardSettings] = None
    pay_by_bank: Optional[CheckoutPayByBankSettings] = Field(default=None, alias="payByBank")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applePay": CheckoutApplePaySettings.from_dict(obj["applePay"]) if obj.get("applePay") is not None else None,
            "card": CheckoutCardSettings.from_dict(obj["card"]) if obj.get("card") is not None else None,
            "payByBank": CheckoutPayByBankSettings.from_dict(obj["payByBank"]) if obj.get("payByBank") is not None else None
        })
        return _obj

...
class PaymentMethodLimit(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["expiresAt", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": [PaymentMethodTotalLimit.from_dict(_item) for _item in obj["total"]] if obj.get("total") is not None else None
        })
        return _obj

...
class PaymentMethodDetailsPage(BaseModel):
    """
    ...
    total: StrictInt
    __properties: ClassVar[List[str]] = ["pageable", "results", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [PaymentMethodDetail.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "total": obj.get("total")
        })
        return _obj

...
class PaymentMethodSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["assets", "description", "displayName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [PaymentMethodAsset.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
